CREATE DATABASE Aplicación de Fitness;
USE Aplicación de Fitness;

CREATE TABLE usuario_fitness (
...
CREATE TABLE entrenamiento (
  ...
  notas VARCHAR(255),
  FOREIGN KEY (id_usuario) REFERENCES usuario_fitness(id_usuario)
);
